              ...
              <Offcanvas.Body>
                <div className="w-100 text-center">
                  <img src={Logo} alt="myPic"
                    ...
                    style={{ width: 150 }} />
                  <h3 className="font-weight-light text-secondary mt-2">UI &amp; React Developer</h3>
                  ...
                  <p className="text-secondary font-weight-light">Front end Skills: <code>React, Angular, JavaScript, jquery, Bootstrap, Semantic UI, Tailwind, HTML5, CSS</code></p>
                  <p className="text-secondary font-weight-light">Back end Skills: <code>NODE js</code></p>
                  <p className="text-secondary font-weight-light">Database: <code>MySQL</code> </p>
